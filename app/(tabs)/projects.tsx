              ...
              <View style={styles.fileRow}>
                {project.pdf_file ? (
                  <TouchableOpacity
                    ...
                    onPress={() => openFile(project.pdf_file)}
                  >
                    <Text style={styles.fileButtonText}>Open PDF</Text>
                  </TouchableOpacity>
                ) : (
                  <View style={[styles.fileButton, styles.disabledFileButton]}>
                    <Text style={styles.disabledFileText}>No PDF</Text>
                  </View>
                )}
                ...
                {project.cad_file ? (
                  <TouchableOpacity
                    ...
                    onPress={() => openFile(project.cad_file)}
                  >
                    <Text style={styles.fileButtonText}>Open CAD</Text>
                  </TouchableOpacity>
                ) : (
                  <View style={[styles.fileButton, styles.disabledFileButton]}>
                    <Text style={styles.disabledFileText}>No CAD</Text>
                  </View>
                )}
              </View>
